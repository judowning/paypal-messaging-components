export default {
    ...
    DEV0AUGENERIC: ['AU', ['short_term'], 'generic'],
    DEV000AULTQGZ: ['AU', ['long_term'], 'long_term_q_gtz'],
    DEV000AULTQEZ: ['AU', ['long_term'], 'long_term_q_eqz'],
    DEV00AULTNQGZ: ['AU', ['long_term'], 'long_term_nq_gtz'],
    DEV00AULTNQEZ: ['AU', ['long_term'], 'long_term_nq_eqz'],
